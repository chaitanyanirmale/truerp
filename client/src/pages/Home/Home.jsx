  ...
  return (
    <div className='bg-white mx-2'>
              ...
              <div className="flex items-center justify-between h-15">
                ...
                <nav className="hidden xl:flex space-x-8 text-gray-700 text-md">
                  <a href="#hero"  className={`transition duration-300 ${
                      active === "hero" ? "text-blue-900 font-semibold" : "text-gray-700 hover:text-blue-900"}`} onClick={()=> setActive("hero")}>Home</a>
                  <a href="#about"  className={`transition duration-300 ${
                      active === "about" ? "text-blue-900 font-semibold" : "text-gray-700 hover:text-blue-900"}`} onClick={()=> setActive("about")}>About</a>
                  <a href="#features"  className={`transition duration-300 ${
                      active === "features" ? "text-blue-900 font-semibold" : "text-gray-700 hover:text-blue-900"}`} onClick={()=> setActive("features")}>Features</a>
                  <a href="#testimonials"  className={`transition duration-300 ${
                      active === "testimonials" ? "text-blue-900 font-semibold" : "text-gray-700 hover:text-blue-900"}`} onClick={()=> setActive("testimonials")}>Testimonials</a>
                  <a href="#services"  className={`transition duration-300 ${
                      active === "services" ? "text-blue-900 font-semibold" : "text-gray-700 hover:text-blue-900"}`} onClick={()=> setActive("services")}>Services</a>
                  <a href="#pricing"  className={`transition duration-300 ${
                      active === "pricing" ? "text-blue-900 font-semibold" : "text-gray-700 hover:text-blue-900"}`} onClick={()=> setActive("pricing")}>Pricing</a>
                  <a href="#industries"  className={`transition duration-300 ${
                      active === "industries" ? "text-blue-900 font-semibold" : "text-gray-700 hover:text-blue-900"}`} onClick={()=> setActive("industries")}>Industries</a>
                  <a href="#client"  className={`transition duration-300 ${
                      active === "client" ? "text-blue-900 font-semibold" : "text-gray-700 hover:text-blue-900"}`} onClick={()=> setActive("client")}>Client</a>
                  <a href="#contact"  className={`transition duration-300 ${
                      active === "contact" ? "text-blue-900 font-semibold" : "text-gray-700 hover:text-blue-900"}`} onClick={()=> setActive("contact")}>Contact</a>
                </nav>
      ...
      <section id="industries" className="p-10 pt-22 bg-gray-100">
        ...
        <div className="grid grid-cols-3 gap-4 px-20 text-center">
          <div className="bg-white rounded-lg p-2 py-3 border border-slate-300 shadow-sm"><i className="fa fa-industry p-2 fa-2x text-blue-900"></i><p className="font-semibold">Manufacturing</p></div>
          <div className="bg-white rounded-lg p-2 py-3 border border-slate-300 shadow-sm"><i className="fa fa-cogs p-2 fa-2x text-blue-900"></i><p className="font-semibold ">Steel Industry</p></div>
          <div className="bg-white rounded-lg p-2 py-3 border border-slate-300 shadow-sm"><i className="fa fa-flask p-2 fa-2x text-blue-900"></i><p className="font-semibold">Chemicals</p></div>
          <div className="bg-white rounded-lg p-2 py-3 border border-slate-300 shadow-sm"><i className="fa fa-paint-brush p-2 fa-2x text-blue-900"></i><p className="text-center font-semibold">Cosmetic</p></div>
          <div className="bg-white rounded-lg p-2 py-3 border border-slate-300 shadow-sm"><i className="fa fa-leaf p-2 fa-2x text-blue-900"></i><p className="text-center font-semibold">Fiber</p></div>
          <div className="bg-white rounded-lg p-2 py-3 border border-slate-300 shadow-sm"><i className="fa fa-building p-2 fa-2x text-blue-900"></i><p className="text-center font-semibold">Concrete</p></div>
          <div className="bg-white rounded-lg p-2 py-3 border border-slate-300 shadow-sm"><i className="fa fa-filter p-2 fa-2x text-blue-900"></i><p className="text-center font-semibold">Filter Mfg</p></div>
          <div className="bg-white rounded-lg p-2 py-3 border border-slate-300 shadow-sm"><i className="fa fa-shopping-bag p-2 fa-2x text-blue-900"></i><p className="text-center font-semibold">Garments</p></div>

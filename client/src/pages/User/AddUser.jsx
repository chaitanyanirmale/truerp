        ...
        <div className="text-md">
            <form onSubmit={handleSubmit}>
                <div className="grid gap-2 px-2">
                    ...
                    <select name="role" onChange={handleChange} value={formData.role} className='border border-slate-300 rounded-sm p-2 w-1/4 placeholder:text-slate-600' required>
                ...
                <div className="grid xl:grid-cols-4 md:grid-cols-3 mt-4 w-full gap-4">
                    ...
                    <div className="grid mx-2">
                        ...
                        <input type="text" name="mobile" id="mobile" value={formData.mobile} onChange={handleChange} placeholder='Mobile No.'className='border border-slate-300 rounded-sm p-2 mt-2' />
                    </div>
                    <div className="grid mx-2">
                    ...
                    <div className="grid mx-2">
                        ...
                        <input type="text" name="alternateMobile" id="alternateMobile" value={formData.alternateMobile} onChange={handleChange} placeholder='Alternate No.'className='border border-slate-300 rounded-sm p-2 mt-2' />
                    </div>
                    <div className="grid mx-2">
                ...
                <div className="mt-4 p-2 w-50 flex justify-between">
                    <button className="bg-blue-700 p-2 rounded-sm text-white hover:scale-105 transition-all duration-700" type="submit" name="submit"><i className="fa fa-fw fa-lg fa-check-circle"></i>Submit</button>
                    <button onClick={()=> setFormData(initialData)} className="bg-gray-700 p-2 rounded-sm text-white hover:scale-105 transition-all duration-700" type="button"><i className="fa fa-fw fa-lg fa-times-circle"></i>Clear</button>
                </div>
            </form>
        </div>
    </div>

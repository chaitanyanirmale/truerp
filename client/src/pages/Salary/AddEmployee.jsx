            ...
            <div className="grid grid-cols-4 gap-6 text-sm my-4">
                ...
                <div className="w-full grid gap-2">
                    ...
                    <select
                        ...
                        className="border border-slate-400 rounded-sm p-2 px-2"
                    >
                ...
                <div className="w-full grid gap-2">
                    ...
                    <select name="position" onChange={handleChange} value={formData.position} className='border border-slate-400 rounded-sm p-2 px-2' >
            ...
            <div className="flex justify-between gap-4 text-sm ">
                ...
                <div className="flex pb-4 gap-4">
                    ...
                    <div className="grid">
                        ...
                        <input type="text" name='pinCode' value={formData.pinCode} placeholder='Enter Pin Code' className='border border-slate-400 p-2 rounded-sm' onChange={handleChange}/>
                    </div>
                </div>
            </div>
            <hr className='text-slate-400 my-4'/>
            <div className="">
                <button type='submit' className="bg-blue-600 hover:bg-blue-800 p-2 rounded-sm text-white px-2 mx-2"><i className='fa fa-check-circle mr-1'></i>{loading ? 'Saving..' : 'Submit'}</button>
                <button type='reset' className='bg-gray-400 hover:bg-gray-500 p-2 rounded-sm '><i className='fa fa-times-circle mr-1'></i>Clear</button>
            </div>
        </form>
    </div>
  )
